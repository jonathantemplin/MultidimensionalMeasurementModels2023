...
Y_{p2} = \mu_1 + \lambda_1 F_{p1} + e_{p2}; e_{p2} \sim N(0, \psi^2_1) \\
\vdots \\
Y_{p5} = \mu_1 + \lambda_1 F_{p1} + e_{p5}; e_{p5} \sim N(0, \psi^2_1)
\end{array}
$$
...
$$
\begin{array}{c}
Y_{p6} = \mu_2 + \lambda_2 F_{p2} + e_{p6}; e_{p6} \sim N(0, \psi^2_1) \\
Y_{p7} = \mu_2 + \lambda_2 F_{p2} + e_{p7}; e_{p7} \sim N(0, \psi^2_1) \\
\vdots \\
Y_{p10} = \mu_2 + \lambda_2 F_{p2} + e_{p10}; e_{p10} \sim N(0, \psi^2_1)
\end{array}
$$
...
$$
\begin{array}{c}
\theta_{p1} = \mu + \lambda F + e_{p1}; e \sim N(0, \psi^2) \\
\theta_{p2} = \mu + \lambda F + e_{p2}; e \sim N(0, \psi^2) \\
\theta_{p3} = \mu + \lambda F + e_{p3}; e \sim N(0, \psi^2) \\
\theta_{p4} = \mu + \lambda F + e_{p4}; e \sim N(0, \psi^2) \\
\end{array}
$$
...
$$
\begin{array}{c}
\theta_{p1} = \mu + \lambda_{1} F + e_{p1}; e_{p1} \sim N(0, \psi^2_1) \\
\theta_{p2} = \mu + \lambda_{2} F + e_{p2}; e_{p2} \sim N(0, \psi^2_2) \\
\theta_{p3} = \mu + \lambda_{3} F + e_{p3}; e_{p3} \sim N(0, \psi^2_3) \\
\theta_{p4} = \mu + \lambda_{4} F + e_{p4}; e_{p4} \sim N(0, \psi^2_4) \\
\end{array}
$$
