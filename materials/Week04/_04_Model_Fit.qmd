...
* While this seems difficult due to the integral, the multivariate normal distribution has a nice property that makes this integral solveable in closed form
...
* __Full information__ means all of the data is used
  * As opposed to __limited information__ where only some of the data is used
...
The multivariate conditional distribution necessitates the assumption that item repsonses are independent conditional on $\boldsymbol{\theta}_p$:
